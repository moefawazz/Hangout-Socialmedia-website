...
if (isset($_POST['postid'])) {
    // Perform necessary actions to toggle the likes in the database
    ...
    try {
        ...
        $selectSql = "SELECT COUNT(*) FROM likes WHERE PostID = :postid AND UserID = :userid";
        ...
        if ($hasReported) {
            ...
            $insertSql = "INSERT INTO likes (PostID, UserID) VALUES (:postid, :userid)";
            ...
            $updateSql = "UPDATE likes SET likes = likes + 1 WHERE PostID = :postid";
